...
public record DatasetResponse(
    ...
    public record DatasetsResponse(@JsonProperty("datasets") List<DatasetResponse> datasets, @JsonProperty("totalCount") int totalCount) {}
    public record DatasetVersionsResponse(@JsonProperty("versions") List<DatasetResponse> versions, @JsonProperty("totalCount") int totalCount) {}
}
