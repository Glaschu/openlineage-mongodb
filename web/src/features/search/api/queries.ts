import { getOpenSearchDatasets, getOpenSearchJobs, getSearch } from '@/features/search/api'
import { useQuery } from '@tanstack/react-query'

import { GroupedSearch, GroupedSearchResult, Search } from '@/shared/types/api'
