...
import BaseSearch from '@/features/search/components/base-search/BaseSearch'
import React from 'react'

// Mock child components
vi.mock('@/features/search/components/SearchListItem', () => ({
...
vi.mock('@/shared/components/MqChip/MqChipGroup', () => ({
