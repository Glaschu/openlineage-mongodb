...
vi.mock('@/shared/utils/nodes', async () => {
  const actual = await vi.importActual<typeof import('@/shared/utils/nodes')>(
    '@/shared/utils/nodes'
  )
  return {
    ...actual,
...
vi.mock('@/features/search/components/open-search/airlfow-logo.svg', () => ({
  __esModule: true,
  default: 'airflow.svg',
}))

vi.mock('@/features/search/components/open-search/dbt-logo.svg', () => ({
  __esModule: true,
  default: 'dbt.svg',
}))

vi.mock('@/features/search/components/open-search/spark-logo.svg', () => ({
  __esModule: true,
  default: 'spark.svg',
}))
