...
const AlationMappings = () => {
  ...
  return (
    <Box p={3}>
      ...
      {/* Suggest Dialog */}
      <Dialog open={suggestOpen} onClose={handleSuggestClose} maxWidth='sm' fullWidth>
        ...
        <DialogActions>
          <Button onClick={handleSuggestClose}>{t('alation_mappings.cancel')}</Button>
          <Button
